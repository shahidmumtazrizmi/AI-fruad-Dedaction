...
export const GoogleIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path
      fill="#FF3D00"
      d="M6.306,14.691l6.06-6.06C9.642,6.053,6.306,4,4.261,4C4.129,4.062,4.002,4.129,3.87,4.2L3.87,4.2z"
      transform="translate(20.13,20.13) rotate(-45) translate(-20.13, -20.13)" 
    />
    <path
      fill="#4CAF50"
